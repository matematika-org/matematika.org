...
# [Орельен Жерон] Прикладное машинное обучение с помощью Scikit-Learn, Keras и TensorFlow 2, 2-е издание [RUS, 2020]

2-е издание утекло в сеть. Надо будет поискать.

Кто захочет разобрать примеры, велком в telegram.
